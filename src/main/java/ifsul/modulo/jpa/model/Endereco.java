...
public class Endereco implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name = "pessoa_id", referencedColumnName = "id", nullable = false, foreignKey = @ForeignKey(name = "fk_pessoa"))
	private Pessoa pessoa;

	@NotNull(message = "O tipo de endereço deve ser informado")
	@ManyToOne
	@JoinColumn(name = "tipo_endereco", referencedColumnName = "id", nullable = false, foreignKey = @ForeignKey(name = "fk_endereco"))
